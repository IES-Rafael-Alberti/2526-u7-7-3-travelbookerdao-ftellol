...
class ReservaHotelDao : IReservaDao<ReservaHotel> {

    private val file = File("data/hoteles.txt")
    ...
    override fun agregar(reserva: ReservaHotel): Boolean {
    ...
    private fun sobrescribir(lista: List<ReservaHotel>) {
        file.writeText("")
